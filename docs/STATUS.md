...
- [x] Verified mobile HTTPS ingress: Let's Encrypt TLS certificate active on `https://bozhidars-macbook-air-2.tail6b3af5.ts.net:8443`; assets, PWA manifest, and service worker all verified 200 OK.
